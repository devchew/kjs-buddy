...
export const PanelDetails: FunctionComponent<{starting?: boolean}> = ({starting}) => (
    <div className="panelDetails">
        <span className="panelDetails__name">PS1 - Krosno</span>
        {!starting && <div className="panelDetails__finish">
            <IconInRedCircle className="panelDetails__finish__icon"><PiFlagCheckeredFill fill="#000" /></IconInRedCircle>
